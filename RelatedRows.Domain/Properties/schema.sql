...
WHERE 
	...
	AND [Table].TABLE_NAME NOT LIKE 'sysdiagrams%' AND [Table].TABLE_NAME NOT LIKE 'spt_%' AND [Table].TABLE_NAME NOT LIKE 'MSRepl%'
	AND [Table].TABLE_NAME NOT LIKE '__RefactorLog%'
ORDER BY 1, 2, 3
