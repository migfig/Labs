...
namespace AppUIBasics
{
    ...
    public partial class ItemPage : Page
    {
        ...
        {
            var item = await InterviewerDataSource.GetKnowledgeArea((int)e.NavigationParameter);
            ...
            if (item != null)
            {
                ...
                string pageString = pageRoot + item.Id + "Page";
        ...
        private void ShowHelp()
        {
            ...
            contentWebView.NavigateToString(HTMLOpenTags + Item.Name + HTMLCloseTags);
